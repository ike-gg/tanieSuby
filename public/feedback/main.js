...
if (orderId == null) {
  location.href = "https://ike-gg.github.io/tanieSuby";
}
...
let onBoard = async () => {
  ...
  if (data.status == "waitingForFeedback") {
    ...
    document.querySelector(
      "#messageHere"
    ).innerHTML = `<b style="font-size:34px">Cześć ${data.order.nickTwitch}!</b><br>Mamy nadzieje ze jestes zadowolony z naszej usługi i z suba na kanale ${data.order.channelTwitch}!<br><br><span style="font-size: 26px">Dziękujemy ❤️</span>`;
